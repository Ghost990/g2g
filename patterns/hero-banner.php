<?php
/**
 * Title: Hero Banner (Inner Pages)
 * Slug: g2f-theme/hero-banner
 * Categories: g2f-theme
 * Keywords: hero, banner, inner, about, services
 * Description: Smaller hero for inner pages (About, Services, etc.)
 */
?>
...
<section id="hero" class="wp-block-group g2f-hero-banner is-layout-flow wp-block-group-is-layout-flow" style="padding-top:0;padding-bottom:0;padding-left:0;padding-right:0;margin-top:0;margin-bottom:0">
	...
	<div class="wp-block-group g2f-hero-wrapper is-layout-flex wp-block-group-is-layout-flex is-nowrap is-content-justification-left" style="padding-top:0;padding-bottom:0;padding-left:0;padding-right:0">
		...
		<!-- wp:cover {"url":"","dimRatio":40,"overlayColor":"black","isUserOverlayColor":true,"minHeight":450,"minHeightUnit":"px","className":"g2f-hero-banner-cover","style":{"spacing":{"padding":{"top":"0","bottom":"0","left":"0","right":"0"}}}} -->
		<div class="wp-block-cover g2f-hero-banner-cover" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;min-height:450px">
			...
			<div class="wp-block-cover__inner-container">
				...
				<div class="wp-block-group is-layout-constrained wp-block-group-is-layout-constrained" style="padding-top:120px;padding-bottom:80px;padding-left:80px;padding-right:80px">
					...
					<div class="wp-block-group is-layout-flex wp-block-group-is-layout-flex is-vertical">
						...
						<!-- wp:paragraph {"style":{"typography":{"fontSize":"16px","fontStyle":"normal","fontWeight":"300","lineHeight":"1.6"}},"textColor":"white","fontFamily":"inter"} -->
						<p class="has-white-color has-text-color has-inter-font-family" style="font-size:16px;font-style:normal;font-weight:300;line-height:1.6">PASSION LED US HERE.</p>
						<!-- /wp:paragraph -->
