		...
		<div class="wp-block-columns">
			...
			<div class="wp-block-column" style="flex-basis:658px">
				...
				<div class="wp-block-group">
					...
					<!-- wp:heading {"level":2,"style":{"typography":{"fontSize":"60px","lineHeight":"1.1"}},"fontFamily":"roboto"} -->
					<h2 class="wp-block-heading has-roboto-font-family" style="font-size:60px;line-height:1.1">We Bring <strong>Creative</strong><br>Ideas To Life.</h2>
					<!-- /wp:heading -->

					<!-- wp:group {"style":{"spacing":{"blockGap":"24px"}},"layout":{"type":"flex","orientation":"vertical"}} -->
					<div class="wp-block-group">

						<!-- wp:paragraph {"style":{"typography":{"fontSize":"24px","lineHeight":"1.5"}},"fontFamily":"roboto"} -->
						<p class="has-roboto-font-family" style="font-size:24px;line-height:1.5">Welcome to G2F Design—a culmination of two decades of experience, relentless curiosity, and a passion for shaping extraordinary visual narratives.</p>
						<!-- /wp:paragraph -->

						<!-- wp:paragraph {"style":{"typography":{"fontSize":"20px","lineHeight":"1.7"}},"textColor":"text-muted"} -->
						<p class="has-text-muted-color has-text-color" style="font-size:20px;line-height:1.7">At G2F Design, we bring creativity to life through UX/UI design, art direction, graphic design, and photography. Our mission is to craft visually striking and user-focused solutions that inspire, engage, and leave a lasting impact.</p>
						<!-- /wp:paragraph -->
